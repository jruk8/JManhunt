...
public final class SpeedrunnerDisconnectTracker {
    ...
    public DisconnectDecision registerDisconnect(UUID playerId, long matchId, int maxStrikes) {
        ...
        return new DisconnectDecision(strikeCount, strikeCount >= normalizedMaxStrikes);
    }
