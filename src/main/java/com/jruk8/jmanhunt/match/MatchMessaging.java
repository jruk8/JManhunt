...
final class MatchMessaging {
    ...
    MatchMessaging(MessageService messages, SoundService sounds, ConfigService configService,
    ...
    void sendToInstance(GameInstance instance, String key, Map<String, String> values) {
    ...
    void playInstanceSound(GameInstance instance, String key) {
        for (Player recipient : store.onlineAssignedPlayers(instance)) {
    ...
    void playInstanceNeutral(GameInstance instance) {
        for (Player recipient : store.onlineAssignedPlayers(instance)) {
    ...
    void sendToInstanceComponent(GameInstance instance, Component rendered) {
        for (Player recipient : store.onlineAssignedPlayers(instance)) {
            recipient.sendMessage(rendered);
        }
        Bukkit.getConsoleSender().sendMessage(rendered);
     ...
     */
    void announceRoleChange(Player player, Role from, Role to) {
    ...
    List<Player> lobbyRecipients(int lobbyId) {
    ...
    void sendToLobby(int lobbyId, String key, Map<String, String> values) {
    ...
    void playLobbySound(int lobbyId, String key) {
