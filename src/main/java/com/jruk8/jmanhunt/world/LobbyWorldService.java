...
final class LobbyWorldService {
    ...
    LobbyWorldService(JManhuntPlugin plugin, MessageService messages) {
        this.plugin = plugin;
     ...
     */
    boolean confirmLobbyGeneration(String senderKey) {
    ...
    Optional<LobbyWorld> ensureLobbyWorld() {
        return ensureLobbyWorld(Optional.empty());
    }

    /** Same, with a one-shot preset override for fresh generation. */
    Optional<LobbyWorld> ensureLobbyWorld(Optional<LobbyPreset> presetOverride) {
     ...
     */
    boolean rescuesVoidIn(World world) {
     ...
     */
    Optional<Location> lobbyRescueLocation(OptionalInt memberLobby) {
     ...
     */
    boolean validateLobbyWorldName() {
     ...
     */
    Location resolveLobby(int lobbyId, boolean logFallback) {
     ...
     */
    Location resolveLobbyTeleport(int lobbyId, List<Player> targets) {
