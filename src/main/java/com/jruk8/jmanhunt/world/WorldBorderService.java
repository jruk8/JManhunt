...
final class WorldBorderService {
    ...
    WorldBorderService(JManhuntPlugin plugin, ConfigService configService) {
        this.plugin = plugin;
     ...
     */
    void applyInstanceBorder(long cellIndex, boolean begun) {
     ...
     */
    void setWorldBorder(World overworld, WorldEngineConfig config, CellOrigin origin) {
    ...
    void clearWorldBorder(World world) {
